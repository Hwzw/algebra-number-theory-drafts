...
The next formula extends the first-level congruence $`S(p+k-1,k)\equiv\lceil k/p\rceil\pmod p`$ of Miska and Ward [\[3, proof of Lemma 2.5\]](#ref-MW).
