...
[**P47: Sharp total variation bounds from spherical rearrangement**](papers/P47-sobolev-variation/README.md), by **Henry Zweiman**, proves the all-order Hilbert case and the complete measure endpoint of the Nazarov-Shcheglova variation conjecture. It also proves strict midpoint height maximization and unique symmetric height extremizers at every finite exponent. Revision 1.5 extends the full variation identity and equality classification to an order-dependent interval immediately above p=1, complementing the earlier interval around two. The interval widths are not estimated, and overlap is not established. Revision 1.6 proves finite nondegenerate critical points and simple residual zeros for every finite-exponent variation maximizer, a uniform critical-point count bound on compact exponent intervals, and an explicit necessary switching Hessian condition. Revision 1.7 excludes every two-switch variation maximizer at every finite exponent, without symmetry assumptions; revision 1.8 also excludes midpoint-symmetric three-switch maximizers and gives a necessary dilation-response condition for remaining three-switch candidates. Nonsymmetric three-switch configurations, counts at least four and the uniform endpoint remain open. Revision 1.9 gives an exact counterexample to the arbitrary positive derivative-weight extension, including smooth weights, and closes the unrestricted weighted Hilbert shortcut. The [35-page PDF](papers/P47-sobolev-variation/manuscript.pdf), [full Markdown](papers/P47-sobolev-variation/manuscript.md), and [LaTeX](papers/P47-sobolev-variation/manuscript.tex) give the proofs.
...
[**P34: Quasipolynomiality and eventual growth at fixed ordinarization number**](papers/P34-ordinarization-growth/README.md), by **Henry Zweiman**, proposes an affirmative answer to Cyrusian–Kaplan Remark 3.7 and eventual strict growth for every fixed positive ordinarization number. It determines the universal leading coefficient and the exact period-two oscillation of the next coefficient. The six-page [PDF](papers/P34-ordinarization-growth/manuscript.pdf), [full Markdown](papers/P34-ordinarization-growth/manuscript.md), and [LaTeX](papers/P34-ordinarization-growth/manuscript.tex) give the complete proof.

The [assessment](papers/P34-ordinarization-growth/ASSESSMENT.md) records the primary open statement, antecedent polyhedral method, priority search, and an unaudited r=3 preprint lead. The [internal review](papers/P34-ordinarization-growth/REVIEW.md) covers the proof and exact diagnostics. Full monotonicity at every genus remains unresolved. Outside correctness, historical novelty, and significance are provisional.
