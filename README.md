...
[**P44: Robin ground states on convex polyhedra: concavity and vanishing spectral gaps**](papers/P44-robin-corners/README.md), by **Henry Zweiman**, now contains counterexamples to the universal positive-Robin gap conjecture and to gap and spectral-ratio monotonicity. Revision 3.1 proves exponentially small gaps and places the Robin ratio below the Dirichlet ratio on the same fixed convex polyhedron, disproving Laugesen's Conjecture B in dimensions at least four. The earlier gap infimum theorem holds at every fixed positive parameter and diameter. The [twenty-nine-page revised PDF](papers/P44-robin-corners/manuscript.pdf), [full Markdown](papers/P44-robin-corners/manuscript.md), and [LaTeX](papers/P44-robin-corners/manuscript.tex) retain the earlier concavity and quasiconcavity results.

The [assessment](papers/P44-robin-corners/ASSESSMENT.md) compares the exact conjectures, the revised Dai--Sun ball theorem, and established geometric and spectral inputs. The [review](papers/P44-robin-corners/REVIEW.md) audits the transverse forms, nested localization, explicit relative-gap comparison, fixed-domain Robin limit and diameter normalization. No numerical eigenvalues are used. This remains one AI-assisted research preprint, without independent expert verification. The gap and ratio questions in dimensions two and three, second-eigenvalue concavity, exceptional polygonal parameters, and the unrestricted local transverse-cone question remain unresolved here.
