...
[**P47: Sharp total variation bounds from spherical rearrangement**](papers/P47-sobolev-variation/README.md), by **Henry Zweiman**, now proves the complete variation identity and equality classification in derivative order three for every finite p>1. Revision 1.11 shows V(3,p)=2C(3,p), and every extremizer is a scalar multiple of the unique midpoint-symmetric height extremizer. A positive action built from quadratic residual vertices excludes all higher nodal counts by constructing a better admissible competitor. The constant identity also holds at p=infinity; classification of all equality cases there remains open. Earlier results include the all-order Hilbert case, the complete measure endpoint, all-order height symmetry at every finite exponent, and local exponent intervals for variation. The remaining all-order variation conjecture is open in orders n>=4. The [44-page PDF](papers/P47-sobolev-variation/manuscript.pdf), [full Markdown](papers/P47-sobolev-variation/manuscript.md), and [LaTeX](papers/P47-sobolev-variation/manuscript.tex) give the proofs.
