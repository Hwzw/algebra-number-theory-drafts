...
## Corner singularities and polyhedral Robin quasiconcavity

[**P44: Corner singularities and quasiconcavity rigidity for Robin ground states**](papers/P44-robin-corners/README.md), by **Henry Zweiman**, gives a discrete-exception disproof of general eventual Robin log-concavity and a proof of the full polyhedral small-parameter quasiconcavity conjecture of Andrews--Clutterbuck--Hauer. Revision 2.0 shows that on every bounded convex polyhedron in dimension at least three outside products of circumsolids, the first eigenfunction has a nonconvex superlevel set for all sufficiently small positive parameters. The [twenty-page revised PDF](papers/P44-robin-corners/manuscript.pdf), [full Markdown](papers/P44-robin-corners/manuscript.md), and [LaTeX](papers/P44-robin-corners/manuscript.tex) contain the global Neumann rigidity proof alongside the earlier analytic corner, prism, and restricted cone results.

The [assessment](papers/P44-robin-corners/ASSESSMENT.md) compares the exact final ACH conjectures and the recent Edelen--Li and Ye--Zhang results. The [review](papers/P44-robin-corners/REVIEW.md) audits the continuous-gradient expansion, elimination of open-edge modes, uniform thin-tube energy estimate, and Hessian-norm identity. Foundational perturbation, spectral, geometric-classification, and regularity inputs are credited. This remains one AI-assisted research preprint, without independent expert verification. Exceptional parameters, the unrestricted local transverse-cone question, and the sharp Robin fundamental gap remain outside the proved results.
