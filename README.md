...
[**P44: Robin ground states on convex polyhedra: concavity and vanishing spectral gaps**](papers/P44-robin-corners/README.md), by **Henry Zweiman**, now contains a disproof of the universal positive-Robin fundamental-gap conjecture. Revision 3.0 proves that for every fixed positive parameter and fixed diameter, the gap has infimum zero over convex polyhedra in every dimension at least four. An explicit four-dimensional member has gap below 1/100 while the comparison interval has gap above one. It also disproves the positive-parameter gap monotonicity conjecture attributed to Smits in Laugesen's survey. The [twenty-six-page revised PDF](papers/P44-robin-corners/manuscript.pdf), [full Markdown](papers/P44-robin-corners/manuscript.md), and [LaTeX](papers/P44-robin-corners/manuscript.tex) retain the earlier concavity and quasiconcavity results.

The [assessment](papers/P44-robin-corners/ASSESSMENT.md) compares the published conjectures, known interval and rectangular-box cases, negative-Robin degeneration, and prior Minkowski geometry. The [review](papers/P44-robin-corners/REVIEW.md) audits the elementary transverse form estimates, exact facet factors, ground-state mass bound, odd trial function and diameter normalization. No numerical eigenvalues are used. This remains one AI-assisted research preprint, without independent expert verification. The positive-gap and monotonicity conjectures in dimensions two and three, exceptional polygonal parameters, and the unrestricted local transverse-cone question remain unresolved here.
