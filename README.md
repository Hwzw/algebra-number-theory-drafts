...
[**P44: Robin ground states on convex polyhedra: concavity and vanishing spectral gaps**](papers/P44-robin-corners/README.md), by **Henry Zweiman**, now contains counterexamples to the universal positive-Robin gap conjecture and to Laugesen's three parameter conjectures A, B and C. Revision 4.0 proves that the second Robin eigenvalue need not be concave in the positive parameter on a convex polyhedron of prescribed diameter in any dimension at least four. An asymmetric end-region construction, with a complete variational spectral convergence proof, gives a strict midpoint violation on one fixed domain. The [thirty-five-page revised PDF](papers/P44-robin-corners/manuscript.pdf), [full Markdown](papers/P44-robin-corners/manuscript.md), and [LaTeX](papers/P44-robin-corners/manuscript.tex) retain the earlier gap, ratio, concavity and quasiconcavity results.

The [assessment](papers/P44-robin-corners/ASSESSMENT.md) compares the exact conjectures and current primary literature. The [review](papers/P44-robin-corners/REVIEW.md) audits the retained transverse coercivity, moving-fiber coordinates, compactness, ordered eigenvalue limits, cut bracketing and strict three-parameter witness. No numerical eigenvalues are used. This remains one AI-assisted research preprint, without independent expert verification. The spectral conjectures in dimensions two and three, exceptional polygonal parameters, and the unrestricted local transverse-cone question remain unresolved here.
