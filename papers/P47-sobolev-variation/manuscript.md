...
The corollary proves the endpoint constant identity. It does not classify every variation extremizer at $p=\infty$. The measure endpoint and its equality classification were already settled by Theorem 9. For derivative orders at least four, the remaining finite-exponent variation problem is still open.

## 17. Remaining questions

The full all-order form of [NS, Conjecture 4.14] remains unresolved. Theorem 17 settles derivative order three at every finite exponent, including coincidence and midpoint symmetry of all extremizers. Its corollary proves the constant identity at the uniform endpoint, where the complete variation equality classification remains open. Theorem 9 gives the complete measure endpoint in every order, and Theorems 5 and 11 give exponent intervals around two and immediately above one. Their widths and overlap are not established. Theorem 10 proves height symmetry and uniqueness at every finite exponent.

For orders $n\ge4$, Theorem 12 supplies finite nondegenerate critical points and simple dual-residual zeros. Theorem 13 excludes every two-switch maximizer, and Theorem 14 excludes midpoint-symmetric three-switch maximizers and restricts every remaining three-switch candidate. Excluding nonsymmetric three-switch configurations and all higher counts remains the finite-exponent task in these orders. The positive action in Section 16 uses the quadratic residual pieces specific to order three; no higher-order extension is proved here.
