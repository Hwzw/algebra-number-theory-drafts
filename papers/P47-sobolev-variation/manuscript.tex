...
statement on an order-dependent interval immediately above one. The full
...
\Needspace{8\baselineskip}\section{11. Remaining questions}\label{remaining-questions}

The full all-exponent form of {[}NS, Conjecture 4.14{]} remains
unresolved. Theorem 9 completes its measure endpoint. Theorems 5 and 11
give order-dependent exponent intervals around two and immediately above
one, respectively. Their widths are not estimated, and their overlap is
not established. Theorem 10 settles midpoint symmetry and
height-extremizer uniqueness for every finite exponent, completing the
k=0, target-L-infinity slice of Conjecture 4.3 together with endpoint
results. What remains for Conjecture 4.14 is the variation identity and
exclusion of competing multiple-peak variation maximizers at the other
exponents. Compactness of a known branch alone does not exclude
coexistence with such a maximizer. The stronger centroid and
knot-reflection inequalities in the research notes remain unproved and
are not needed for Theorems 9-\/-11.
