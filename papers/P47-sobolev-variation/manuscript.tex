...
with the endpoint results. The full all-exponent variation conjecture
remains open.
...
\Needspace{8\baselineskip}\section{10. Remaining questions}\label{remaining-questions}

The full all-exponent form of {[}NS, Conjecture 4.14{]} remains
unresolved. Theorem 9 completes its measure endpoint, and Theorem 5
proves an order-dependent open interval about two. Theorem 10 settles
midpoint symmetry and height-extremizer uniqueness for every finite
exponent, completing the k=0, target-L-infinity slice of Conjecture 4.3
together with the endpoint results. What remains for Conjecture 4.14 is
to prove the variation identity and exclude competing multiple-peak
variation maximizers at the other exponents. Compactness alone does not
do this. The stronger centroid and knot-reflection inequalities in the
research notes remain unproved and are not needed for Theorems 9 and 10.
