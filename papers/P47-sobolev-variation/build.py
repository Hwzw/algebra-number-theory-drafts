...
body=body.replace(r'Let \(C_{n,p}\) and \(V_{n,p}\)', r'\Needspace{6\baselineskip}Let \(C_{n,p}\) and \(V_{n,p}\)',1)
body=body.replace(r'\subsection{16.11. The constant', r'\Needspace{10\baselineskip}\subsection{16.11. The constant')
