...
stability, arbitrary vertex couplings, and a sharp Kohler-Jobin
inequality relating torsion and the first eigenvalue remain outside the
result. In particular, the two separate extremal comparisons do not
settle the product problem discussed in {[}OT, Section 8.3{]}.
